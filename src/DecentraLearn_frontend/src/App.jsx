...
import { createActor } from 'declarations/DecentraLearn_backend';
import { canisterId } from 'declarations/DecentraLearn_backend/index.js';
...
function App() {
  ...
  function handleSubmit(event) {
    ...
    DecentraLearn_backend.greet(name).then((greeting) => {
